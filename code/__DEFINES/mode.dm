...
GLOBAL_LIST_INIT(ROLES_PMCPLT, list(JOB_PMCPLAT_OW, JOB_PMCPLAT_LEADER, JOB_PMCPLAT_FTL, JOB_PMCPLAT_SG, JOB_PMCPLAT_STANDARD, JOB_PMCPLAT_MEDIC, JOB_PMCPLAT_MP, JOB_PMCPLAT_CREW, JOB_PMC_SYNTH, JOB_COMBAT_REPORTER))
